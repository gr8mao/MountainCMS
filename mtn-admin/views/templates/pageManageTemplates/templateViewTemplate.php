...
<div class="ui grid">
    ...
    <div class="thirteen wide column">
        <div class="admin content">
            <h1>Шаблоны сайта <? echo SITE_NAME; ?></h1>
            <div class="ui grid">
                <div class="eleven wide column">
                    <a class="ui left button blue labeled icon" href="/mtn-admin/templates/add"><i
                    ...
                    <tr class="file" data-path="<? echo $file['file_path'] ?>">
                        ...
                        <td class="collapsing right floated ">
                            <a class="ui primary icon button"
                               href="/mtn-admin/templates/edit/<?echo $file['file_name'];?>">
                                <i class="edit icon"></i>
                            </a>
                            <a class="ui red icon button deleteTemplate">
