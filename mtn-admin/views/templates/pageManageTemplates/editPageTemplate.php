                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="ui fluid dropdown selection" name="page_status" id="page_status">
                                            <option value="published" <? if ($pageInfo['page_status'] == 'published') {
                                                echo 'selected';
                                            } ?>>Опубликовано
                                            </option>
                                            <option value="draft" <? if ($pageInfo['page_status'] == 'draft') {
                                                echo 'selected';
                                            } ?>>Черновик
                                            </option>
                                            <option value="blocked" <? if ($pageInfo['page_status'] == 'blocked') {
                                                echo 'selected';
                                            } ?>>Заблокировано
                                            </option>
                                        </select>
                        ...
                        <div class="ui piled segment">
                            ...
                            <table class="ui very basic collapsing celled table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <? echo User::getUsernameById($pageInfo['page_added_by']); ?>
                                        ,<br> <? echo $pageInfo['page_create_date']; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <? echo User::getUsernameById($pageInfo['page_lastModBy']); ?>
                                        ,<br> <? echo $pageInfo['page_modify_date']; ?>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
        ...
        <div class="ui grid centered link cards">
            <? if ($filesList): ?>
                <? foreach ($filesList as $file): ?>
                    <div class="five wide column mediaCard">
...
<script>
    ...
    $('.mediaCard').on("click", function () {
        ...
        toastr.success('Тег изображения вставлен в код страницы!');
        return false;
    });
